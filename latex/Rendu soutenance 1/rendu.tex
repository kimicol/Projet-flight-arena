...
\subsection{Scripts}
Tous les scripts en C\# du jeu ont été fait par Arthur grâce à des tutoriels sur internet. Il a entré les différentes saisies possibles du joueur, qui provoquent sur le vaisseau des translations lorsque le joueur veut avancer ou des rotations lorsque le joueur veut tourner.
